...
exports.invoiceFranchiseTemplate = void 0;
const formatCurrency = (v) => {
    return `$${(v ?? 0).toFixed(2)}`;
};
const invoiceFranchiseTemplate = (data) => {
    const franchiseName = data.franchiseName || 'Franchise';
    const customerName = data.customerName || 'Customer';
    const customerEmail = data.customerEmail || '—';
    const invoiceNumber = data.invoiceNumber || 'N/A';
    const companyName = data.companyName || 'AB Lawns & Garden Care';
...
exports.invoiceFranchiseTemplate = invoiceFranchiseTemplate;
//# sourceMappingURL=invoiceFranchise.template.js.map