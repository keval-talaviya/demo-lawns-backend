...
exports.quotationFranchiseTemplate = void 0;
const quotationFranchiseTemplate = (q) => {
    ...
    <div style="font-family: Arial, sans-serif; color: #333; max-width: 600px;">
      ...
      <p style="margin-top: 20px;">Regards,<br/><b>AB Lawns & Garden Care</b></p>
    </div>
  `;
};
exports.quotationFranchiseTemplate = quotationFranchiseTemplate;
//# sourceMappingURL=quotationFranchise.template.js.map