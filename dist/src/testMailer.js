...
(async () => {
    await (0, mail_sercice_1.sendEmail)({
        to: 'devanihet143@gmail.com',
        subject: '📄 New Quotation Created — AB LAWNS',
        html: `
    <!doctype html>
    <html lang="en">
    <head>
      ...
      <title>New Quotation — AB LAWNS</title>
      <style>
            ...
            <table role="presentation" class="container" width="600" cellpadding="0" cellspacing="0" style="background:#fff; border-radius:8px; overflow:hidden; box-shadow:0 4px 18px rgba(0,0,0,0.06);">
              ...
              <tr>
                <td style="padding:18px 24px; background:linear-gradient(90deg,#2E8B57,#145A32); color:#fff;">
                  <table role="presentation" width="100%">
                    <tr>
                      <td><img src="https://your-cdn.example.com/ab-lawns-logo.png" alt="AB LAWNS" width="140" style="display:block; border:0;"></td>
                      <td style="text-align:right;">
                        <strong style="font-size:16px;">AB LAWNS</strong><br/>
              ...
              <tr>
                <td style="padding:16px 24px;">
                  <a href="https://your-crm.example.com/franchise/quotations/123456"
                     class="cta"
              ...
              <tr>
                <td style="padding:18px 24px; border-top:1px solid #eef1ef;">
                  <p style="margin:0; font-weight:600;">AB LAWNS Management</p>
                  <p style="margin:6px 0; font-size:13px; color:#666;">
                    12 Garden Avenue, Sector 45, Ahmedabad, Gujarat<br/>
                    📞 +91 98765 43210 | ✉️ support@ablawns.example.com
                  </p>
                  <p style="margin:10px 0 0; font-size:12px; color:#888;">
                    © 2025 AB LAWNS. All rights reserved.
                  </p>
                </td>
              </tr>
